...
class SellerRegistrationScreen extends StatefulWidget {
  ...
  static String id = 'sellerRegistration';
  @override
...
class _SellerRegistrationScreenState extends State<SellerRegistrationScreen> {
  ...
  final TextEditingController confirmPasswordEditingController =
      TextEditingController();
  final TextEditingController farmNameEditingController = TextEditingController();
  bool circular = false;
  ...
  Widget build(BuildContext context) {
    ...
    final farmName = TextFormField(
      controller: farmNameEditingController,
      ...
      onSaved: (value) {
        farmNameEditingController.text = value!;
      },
      textInputAction: TextInputAction.next,
      decoration: InputDecoration(
        prefixIcon: const Icon(Icons.person, color: Colors.deepOrangeAccent),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      child: Text("SignUp as CropSeller!",
                          textAlign: TextAlign.center,
  ...
  postDetailsToServer() async {
    ...
    userModel.farmName=farmNameEditingController.text;
    userModel.role = "Seller";
    userModel.companyName="This user is a CropSeller";
